...
module.exports = {
    ...
    execute(msg, args) {
        ...
        .setColor('#55128E')
        .setDescription(`Lets the user search for various anime, manga, characters and quotes from the extensive selection at AniList.co. Uses the AniList.co GraphQL API to fetch images, titles, ratings, episode count, etc...`)
